...
tf.app.flags.DEFINE_integer('input_mode', 0,
...
tf.app.flags.DEFINE_string(
    'dataset_dir', './dataset/action_merge/jp_2s', 'The directory where the dataset files are stored.')
...
tf.app.flags.DEFINE_string(
    'model_name', 'action_vgg_e', 'The name of the architecture to train.')
